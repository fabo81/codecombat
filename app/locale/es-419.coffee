...
#    not_assigned_modal_full_body_3: "Please select fewer students, or reach out to __supportEmail__ for assistance."
    ...
    apply_licenses_to_the_following_students: "Aplicar licencias a los siguientes estudiantes" #"Apply Licenses to the Following Students"
    students_have_licenses: "Los siguientes estudiantes ya cuentan con licencia" #"The following students already have licenses applied:"
...
#    enrollments_blurb: "Students are required to have a license to access any content after the first course."
    how_to_apply_licenses: "¿Cómo aplicar una licencia?" #"How to Apply Licenses"
    export_student_progress: "Exportar el Progreso del Estudiante(CSV)"
#    send_email_to: "Send Recover Password Email to:"
    email_sent: "Correo enviado" #"Email sent"
    send_recovery_email: "Enviar correo de recuperación" #"Send recovery email"
    enter_new_password_below: "A continuación, escriba la nueva contraseña" #"Enter new password below:"
    change_password: "Cambiar contraseña" #"Change Password"
    changed: "Ha sido cambiado" #"Changed"
    available_credits: "Licencias Disponibles" #"Available Licenses"
...
#    license_status: "License Status"
    status_expired: "Expiró en {{date}}" #"Expired on {{date}}"
#    status_not_enrolled: "Not Enrolled"
    status_enrolled: "Expira en {{date}}" #"Expires on {{date}}"
    select_all: "Seleccionar Todo" #"Select All"
    project: "Proyecto" #"Project"
    project_gallery: "Galería de Proyectos" #"Project Gallery"
    view_project: "Ver Proyecto" #"View Project"
    unpublished: "(No publicado)" #"(unpublished)"
...
#    educator_faq_desc: "Frequently asked questions about using CodeCombat in your classroom or school."
    teacher_getting_started: "Guía de Inicio para Maestros" #"Teacher Getting Started Guide"
#    teacher_getting_started_desc: "New to CodeCombat? Download this Teacher Getting Started Guide to set up your account, create your first class, and invite students to the first course."
    student_getting_started: "Guía de Inicio Rápido para Estudiantes" #"Student Quick Start Guide"
